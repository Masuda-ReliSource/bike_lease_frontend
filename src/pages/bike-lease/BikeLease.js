        ...
        <form onSubmit={handleSubmit(submitForm)}>
          <div className="flex space-x-4">
            ...
            <div className="mb-4">
              ...
              />
              <p className="text-red-500">{errors?.down_payment?.message}</p>
            </div>
            ...
            <div className="mb-4 w-full">
              <div>
                <label>
                  Bikes:<span className="text-red-500">*</span>
                </label>
              </div>
          ...
          <div className="flex justify-center space-x-4">
            <div>
              ...
              <div className="mb-4">
                ...
                <input
                  {...register("leasee_name", { required: "Name is required" })}
                  type="text"
                  placeholder="eg. John Doe"
                  className="p-2 border-2 rounded hover:border-2 hover:border-sky-500 focus:outline-sky-500"
                />
                <p className="text-red-500">{errors?.leasee_name?.message}</p>
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="p-2 border-2 rounded hover:border-2 hover:border-sky-500 focus:outline-sky-500"
                />
                <p className="text-red-500">{errors?.leasee_phone?.message}</p>
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  {...register("leasee_monthly_income", {
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="p-2 border-2 rounded hover:border-2 hover:border-sky-500 focus:outline-sky-500"
                />
                <p className="text-red-500">{errors?.leasee_dob?.message}</p>
              </div>
              {/* ----------Leasee Information-------------- */}
            </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <input
                  {...register("closee_name")}
                  type="text"
                  placeholder="eg. John Doe"
                  className="p-2 border-2 rounded hover:border-2 hover:border-sky-500 focus:outline-sky-500"
                />
                <p className="text-red-500">{errors?.closee_name?.message}</p>
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  {...register("closee_phone")}
                  type="text"
                  placeholder="eg. 95655425555"
                  className="p-2 border-2 rounded hover:border-2 hover:border-sky-500 focus:outline-sky-500"
                />
                <p className="text-red-500">{errors?.closee_phone?.message}</p>
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  {...register("closee_monthly_income")}
                  type="text"
                  placeholder="eg. 5265555"
                  className="p-2 border-2 rounded hover:border-2 hover:border-sky-500 focus:outline-sky-500"
                />
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="p-2 border-2 rounded hover:border-2 hover:border-sky-500 focus:outline-sky-500"
                />
                <p className="text-red-500">{errors?.closee_dob?.message}</p>
              </div>
              {/* ----------Closee Information-------------- */}
            </div>
          </div>
